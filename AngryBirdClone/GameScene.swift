...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
       ...
       */
        //PhysicsBody
        self.physicsBody = SKPhysicsBody(edgeLoopFrom: frame)  //Boylece kusun yercekimine gore duserken duracagi zemin kismini ayarladik
        self.scene?.scaleMode = .aspectFit  //Ekranin duzgun gorunmesi
        ...
        bird.physicsBody = SKPhysicsBody(circleOfRadius: birdTexture.size().height/16) // Kusun etrafini belirledik (Mavi cizgi)
        bird.physicsBody?.affectedByGravity = false //yercekimi ekledik
    ...
    override func update(_ currentTime: TimeInterval) {
        // Called before each frame is rendered  (Devamli kontrol saglanan)
